...
@Component({
  selector: 'ngx-back-aliment',
  templateUrl: './back-aliment.component.html',
  styleUrls: ['./back-aliment.component.scss']
})
export class BackAlimentComponent implements AfterViewInit, OnDestroy {
  options: any = {};
